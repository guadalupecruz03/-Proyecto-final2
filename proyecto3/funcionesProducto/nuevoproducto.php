...
<nav class="navbar navbar-expand-lg bg-body-tertiary bgcolor navbar bg-dark border-bottom border-body" data-bs-theme="dark">
    ...
    <section id="Portafolio">
        <form action="guardarNEWpro.php" method="post" enctype="multipart/form-data">
            <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                <p class="lead fw-normal mb-0 me-3">Crear nuevo producto</p>
            </div><br>

            <!-- Nombre input -->
            <div class="form-outline mb-4">
                <input type="text" id="nombre" class="form-control form-control-lg"
                    placeholder="Introduce el nombre del producto" name="nombre" required />
            ...
            <div class="form-outline mb-4">
                <input type="text" id="descripcion" class="form-control form-control-lg"
                    placeholder="Introduce una descripcion" name="descripcion" required />
                <label class="form-label" for="descripcion">descripcion</label>
            </div>

            <!-- Email input -->
            <div class="form-outline mb-4">
                <input type="num" id="precio" class="form-control form-control-lg"
            ...
            <!-- Teléfono input -->
                <input type="file" id="imagen" class="form-control form-control-lg"
                    placeholder="Introduce una imagen" name="imagen" required />
                <label class="form-label" for="imagen">imagen</label>
            </div>

            <!-- Password input -->
            <div class="form-outline mb-4">
                <input type="date" id="fecha_creacion" class="form-control form-control-lg"
                    placeholder="Introduce la fecha_creacion" name="fecha_creacion" required />
                <label class="form-label" for="fecha_creacion">fecha</label>
            </div>

            <div class="text-center text-lg-start mt-4 pt-2">
                <input type="submit" class="btn btn-outline-primary"
                    style="padding-left: 2.5rem; padding-right: 2.5rem;" value="Guardar producto">
            </div>
        </form>
    </section><br>
