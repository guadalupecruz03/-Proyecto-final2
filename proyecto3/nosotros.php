...
<nav class="navbar navbar-expand-lg bg-body-tertiary bgcolor navbar bg-dark border-bottom border-body" data-bs-theme="dark">
  ...
  <center><h1>NOSOTROS</h1></center><br><br>
  <p>Bienvenidos a Manualidades Alegres y Macabras, tu tienda en línea para encontrar las manualidades más divertidas y espeluznantes para Halloween y Navidad. Nos dedicamos a proporcionar productos únicos y creativos que te ayudarán a decorar tu hogar de manera especial en estas festividades.</p>
    <p>Nuestro equipo está formado por amantes de las manualidades que se esfuerzan por ofrecerte productos de alta calidad y diseñados con creatividad. Nos apasiona hacer que cada celebración sea única y memorable.</p>
