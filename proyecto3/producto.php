...
<nav class="navbar navbar-expand-lg bg-body-tertiary bgcolor navbar bg-dark border-bottom border-body" data-bs-theme="dark">
  ...
  <!-- boton nuevo-->
  <a class="btn btn-outline-info" href="./funcionesProducto/nuevoproducto.php" role="button">Nuevo</a>
  <!-- tabla -->
        ...
        <?php
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td>
                            <a href="./funcionesProducto/eliminarProducto.php?id=' . $row["id"] . '">Eliminar</a>
                            <a href="./funcionesProducto/editarPRO.php?id=' . $row["id"] . '">Editar</a>
                          </td>';
                    echo "</tr>";
                }
            } else {
